...
# Bestanden inlezen
weather_file = r"C:\Users\nasro\Downloads\weather_new.csv"
journey_file = r"C:\Users\nasro\Downloads\147JourneyDataExtract30Jan2019-05Feb2019.csv"
stations_file = r"C:\Users\nasro\Downloads\cycle_stations.csv"
london_stations_file = r"C:\Users\nasro\Downloads\London stations.csv"
...
# Sidebar voor dashboard selectie
dashboard_option = st.sidebar.selectbox("Selecteer Dashboard:", ["Oud Dashboard", "Nieuw Dashboard"])

if dashboard_option == "Oud Dashboard":
    ...
    # Functie om weerdata te laden met caching
    @st.cache_data
    def load_weather_data(file_path):
        return pd.read_csv(file_path)

    # Functie om de reisdata te laden met caching
    @st.cache_data
    def load_journey_data(file_path):
        return pd.read_csv(file_path)

    # Importeer de weerdata van 2016
    weather_file = r"C:\Users\nasro\Downloads\weather_new.csv"
    weather_df = load_weather_data(weather_file)  # Vervang dit pad met het juiste pad naar je weerdata

    # Importeer de Cleaned_Dataset
    journey_file = r"C:\Users\nasro\Downloads\merged_data_new.csv"
    ...
    # Zorg ervoor dat de 'Date' kolom in weather_df van het type datetime is:
    ...
    st.markdown("Een interactief dashboard voor het analyseren van fietsreizen en weerdata.")
    dashboard_option = st.sidebar.selectbox("Kies een dashboard optie", ["Nieuw Dashboard"])

    if dashboard_option == "Nieuw Dashboard":
